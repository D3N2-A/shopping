...
function Navbar() {
  ...
  return (
    <div className="relative flex items-center justify-start p-4 lg:px-6">
      <a className="mr-2 flex w-full items-center justify-center md:w-auto lg:mr-6 cursor-pointer">
      ...
      <div className="gap-6 flex flex-row items-center justify-start">
        <div
          className="text-neutral-500 hover:underline hover:text-white transition-all cursor-crosshair underline-offset-4"
          onClick={() => {
            router.push("/items");
          }}
        >
